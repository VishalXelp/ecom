            ...
            <div className="col-lg-3 col-md-6">
                <div className="single-footer-widget">
                    ...
                    <ul className="footer-contact-info">
                        <li><i className="fas fa-map-marker-alt"></i> Location: 2750 Street , walking Road</li>
                        <li><i className="fas fa-phone"></i> Call Us: <a href="#">(+91) 456-XXX-7898</a></li>
                        <li><i className="far fa-envelope"></i> Email Us: <a href="#">support@comero.com</a></li>
                        <li><i className="fas fa-fax"></i> Fax: <a href="#">+12XYZ456</a></li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div className="container">
            <div className="row align-items-center">
                <div className="col-lg-6 col-md-6">
                    <p>Copyrite @ 20XX All Rights Reserved</p>
                </div>
{/* 
                <div className="col-lg-6 col-md-6">
